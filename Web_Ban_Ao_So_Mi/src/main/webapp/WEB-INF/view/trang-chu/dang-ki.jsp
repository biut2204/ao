        ...
        <li class="menu_link">
            <form method="post">
                <input type="text" name="timKiem"
                       style="width: 6cm; height: 30px;border-radius: 15px; padding-left: 10px">
...
<form method="post">
    <div class="login">
        ...
        <form action="login.mk" class="dangky">
            <input type="text" name="ten" placeholder="Nhập tên"
                   style="width: 950px; height: 50px;border-radius: 25px;margin-left: 10%">

            <input type="date" name="ngaySinh" style="width: 450px; height: 50px;border-radius: 25px;margin-left: 10%;margin-top: 10px">

            <select name="quocGia" style="width: 950px; height: 50px;border-radius: 25px;margin-left: 10%;margin-top: 10px">
                <option selected>Quốc gia</option>
                <option value="Việt Nam">Việt Nam</option>
                <option value="Hàn Quốc">Hàn Quốc</option>
                <option value="Trung quốc">Trung quốc</option>
            </select>
            <input type="text" name="thanhPho" placeholder="Nhập thành phố"
                   style="width: 950px; height: 50px;border-radius: 25px;margin-left: 10%;margin-top: 10px">
            ...
            <input type="password" name="matKhau" placeholder="Nhập mật khẩu"
                   style="width: 950px; height: 50px;border-radius: 25px;margin-left: 10%;margin-top: 10px">
            <button formaction="/nguoi-dung/dang-ki" style="margin-left: 43%;margin-top: 30px">Đăng kí</button>
            <h1>${loi}</h1>
        </form>
        <a href="/nguoi-dung/view-dang-nhap/2" class="link">Đăng nhập</a> <a href="/nguoi-dung/view-quen-mat-khau/2" class="link" style="margin-left: 80%">Quên mật khẩu</a>
    </div>
</form>
<footer>
    <div class="gioithieu">
