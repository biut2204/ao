...
<div class="nav">
    ...
    <ul class="menu">
        ...
        <li class="menu_link">
            <form method="post">
                <input type="text" name="timKiem" style="width: 6cm; height: 30px;border-radius: 15px; padding-left: 10px;padding-top: 20px">
                <button formaction="/nguoi-dung/tim-kiem/${idKh}" style="width: 100px;height: 50px;margin-top: 10px;border-radius: 25px">Search</button>
            </form>
        </li>
        <li class="menu_link">
...
<!-- Page content -->
<div class="content" >
    <div style="padding-top: 100px"> Chưa biết set up gì</div>
</div>
