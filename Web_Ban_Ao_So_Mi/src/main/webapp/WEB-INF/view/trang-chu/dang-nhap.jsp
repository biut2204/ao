...
<form method="post">
    <div class="login">
        ...
        <form action="login.mk" class="dangky">
            <input type="text" name="tk" placeholder="Nhập email"
            ...
            <button formaction="/nguoi-dung/dang-nhap" style="margin-left: 43%;margin-top: 30px">Đăng nhập</button>
            <h1>${loi}</h1>
        </form>
        <a href="/nguoi-dung/view-dang-ki/2" class="link">Đăng ký</a>
        <a href="/nguoi-dung/view-quen-mat-khau/2" class="link" style="margin-left: 80%">Quên mật khẩu</a>
    </div>
</form>
<footer>
    <div class="gioithieu">
