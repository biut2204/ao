        ...
        <form method="post">
            <div class="login">
                ...
                <form action="login.mk" class="dangky">
                    ...
                    <input type="text" name="mkc" placeholder="Nhập mật khẩu cũ"
                           style="width: 950px; height: 50px;border-radius: 25px;margin-left: 10%">
                    <input type="text" name="mkm1" placeholder="Mật khẩu mới"
                           style="width: 950px; height: 50px;border-radius: 25px;margin-left: 10%;margin-top: 10px">
                    <input type="text" name="mkm2" placeholder="Nhập lại mật khẩu mới"
                           style="width: 950px; height: 50px;border-radius: 25px;margin-left: 10%;margin-top: 10px">
                    <button formaction="/nguoi-dung/an-doi-mat-khau" style="margin-left: 43%;margin-top: 30px;width: 100px;border-radius: 15px">Đổi mật khẩu</button>
                    <h1>${loi}</h1>
                </form>
            </div>
        </form>
