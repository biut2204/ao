...
<div class="container" style="border: 1px solid black;border-radius: 10px;padding: 20px;margin-left: 300px">
    <form action="/product/hang" method="post">
    ...
    color: black;font-family: 'Lora';text-align: center;">Danh Sách Hãng Aó</h1>
        <table class="table" style="margin: 20px 0;">
            ...
            <c:forEach items="${items}" var="sp">
                <tr >
                    ...
                    <th><a href="/product/detail/hang/${sp.ma}">Detail</a></th>
                </tr>
            </c:forEach>
            </tbody>
        </table>
