...
<div class="container" style="border: 1px solid black;border-radius: 10px;padding: 20px;margin-left: 300px">
    <form action="/product/coao" method="post">
        <input type="text" hidden name="id" value="${item.id}">
        <div class="form-group">
            <label for="formGroupExampleInput">Mã</label>
            <input type="text" name="ma" value="${item.ma}" class="form-control" id="formGroupExampleInput" placeholder="Mã Cổ Aó">
        </div>
        <div class="form-group">
            <label for="formGroupExampleInput2">Tên</label>
            <input type="text" name="ten" value="${item.ten}" class="form-control" id="formGroupExampleInput2" placeholder="Tên Cổ Aó">
        </div>
    ...
    color: black;font-family: 'Lora';text-align: center;">Danh Sách Cổ Aó</h1>
        <table class="table" style="margin: 20px 0;">
            <thead class="thead-light">
            <tr>
                <th scope="col">Mã</th>
                <th scope="col">Tên Cổ Aó</th>
            ...
            <c:forEach items="${items}" var="sp">
                <tr >
                    ...
                    <th><a href="/product/detail/coao/${sp.ma}">Detail</a></th>
                </tr>
            </c:forEach>
            </tbody>
        </table>
