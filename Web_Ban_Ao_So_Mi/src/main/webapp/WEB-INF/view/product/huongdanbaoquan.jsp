...
<div class="container" style="border: 1px solid black;border-radius: 10px;padding: 20px;margin-left: 300px">
    <form action="/product/add-huongdanbaoquan" method="post">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="chitiet">${item.chitiet}</textarea>
        </div>
    ...
    color: black;font-family: 'Lora';text-align: center;">Danh Sách Hướng Dẫn Bảo Quản Aó</h1>
        <table class="table" style="margin: 20px 0;">
            ...
            <c:forEach items="${items}" var="sp">
                <tr >
                    ...
                    <th><a href="/product/detail/huongdanbaoquan/${sp.ma}">Detail</a></th>
                </tr>
            </c:forEach>
            </tbody>
        </table>
